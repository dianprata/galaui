...
function parseCvaDefaultVariants(fileContent: string): Record<string, Record<string, string>> {
...
export function generateApiDocs(): ApiReferenceData {
  ...
  const components: Record<string, ComponentApiDoc> = {};
  ...
  for (const file of files) {
    ...
    const fileComponentNames: string[] = [];
...
const tsContent = `// Auto-generated by scripts/generate-api-docs.ts - do not edit directly

...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("border-b border-border bg-muted/40 [&_tr]:border-b", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-9 px-3.5 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-3 text-[11px] text-muted-foreground", className)}
    {...props}
  />
));
